...
ComputeParticleLayer::ComputeParticleLayer()
...
void ComputeParticleLayer::OnAttach()
{
...
void ComputeParticleLayer::OnDetach()
{

}

void ComputeParticleLayer::OnUpdate(float deltaTime)
{
	...
	Engine::ShaderLibrary::Get("Particle")->Bind();
	Engine::ShaderLibrary::Get("Particle")->UploadUniformMat4("u_ViewProjectionMatrix", m_Camera.GetViewProjection());
...
void ComputeParticleLayer::OnEvent(Engine::Event& event)
{
	Engine::EventDispatcher dispatcher(event);

	dispatcher.Dispatch<Engine::KeyPressedEvent>(BIND_FN(ComputeParticleLayer::OnKeyPressed));

	m_Camera.OnEvent(event);
}

bool ComputeParticleLayer::OnKeyPressed(Engine::KeyPressedEvent& event)
{
...
void ComputeParticleLayer::Reset()
{
	OnAttach();
}

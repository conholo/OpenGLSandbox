...
namespace Engine
{
	namespace ImageUtils
	{
		...
		GLenum ConverDataLayoutMode(ImageDataLayout pixelDataFormat)
		{
			switch (pixelDataFormat)
			{
			case ImageDataLayout::None:				return 0;
			case ImageDataLayout::RGBA:				return GL_RGBA;
			case ImageDataLayout::RGB:				return GL_RGB;
			case ImageDataLayout::RG:				return GL_RG;
		...
		GLenum ConvertTextureAccessLevel(TextureAccessLevel accessLevel)
		{
			switch (accessLevel)
			{
			case TextureAccessLevel::None:		return 0;
			case TextureAccessLevel::ReadOnly:	return GL_READ_ONLY;
			case TextureAccessLevel::WriteOnly:	return GL_WRITE_ONLY;
			case TextureAccessLevel::ReadWrite:	return GL_READ_WRITE;
			}
		...
		GLenum ConvertShaderFormatType(TextureShaderDataFormat shaderDataFormat)
		{
			...
			{
			case TextureShaderDataFormat::None:			return 0;
			case TextureShaderDataFormat::RGBA32F:		return GL_RGBA32F;
			case TextureShaderDataFormat::RGBA16F:		return GL_RGBA16F;
			case TextureShaderDataFormat::RG32F:		return GL_RG32F;
			case TextureShaderDataFormat::RG16F:		return GL_RG16F;
			case TextureShaderDataFormat::R11FG11FB10F:	return GL_R11F_G11F_B10F;

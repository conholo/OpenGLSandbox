...
void SceneRendererPipelineDemoLayer::OnAttach()
{
...
void SceneRendererPipelineDemoLayer::OnDetach()
{
	Engine::SceneRenderer::UnloadScene();
}

void SceneRendererPipelineDemoLayer::OnUpdate(float deltaTime)
{
...
void SceneRendererPipelineDemoLayer::OnImGuiRender()
{
...
void SceneRendererPipelineDemoLayer::OnEvent(Engine::Event& event)
{
	Engine::EventDispatcher dispatcher(event);

	Engine::SceneRenderer::OnEvent(event);

	dispatcher.Dispatch<Engine::KeyPressedEvent>(BIND_FN(SceneRendererPipelineDemoLayer::OnKeyPressed));
	dispatcher.Dispatch<Engine::WindowResizedEvent>(BIND_FN(SceneRendererPipelineDemoLayer::OnResize));
}

bool SceneRendererPipelineDemoLayer::OnKeyPressed(Engine::KeyPressedEvent& keyPressedEvent)
{
	return false;
}

bool SceneRendererPipelineDemoLayer::OnResize(Engine::WindowResizedEvent& windowResizeEvent)
{
	return false;
}

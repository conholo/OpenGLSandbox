...
void LightingLayer::OnAttach()
{
	...
	m_DiscoBall = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Sphere, "BlinnPhong");
	m_Plane = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Plane, "BlinnPhong");
	m_Wall = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Quad, "BlinnPhong");
	m_Wall->GetEntityTransform()->SetPosition({ 0.0f, 12.0f, -22.5f });
	m_Wall->GetEntityTransform()->SetScale({ 50.0f, 25.0f, 50.0f });


	m_DisplayCube = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Cube, "BlinnPhong");
	...
	m_DisplaySphere = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Sphere, "BlinnPhong");
	...
	m_TexturedDisplaySphere = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Sphere, "BlinnPhong");
	...
	Engine::Ref<Engine::SimpleEntity> catWalkCube = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Cube, "BlinnPhong");
	Engine::Ref<Engine::SimpleEntity> catWalkTriangle = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Triangle, "BlinnPhong");
	Engine::Ref<Engine::SimpleEntity> catWalkQuad = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Quad, "BlinnPhong");
	Engine::Ref<Engine::SimpleEntity> catWalkSphere = Engine::CreateRef<Engine::SimpleEntity>(Engine::PrimitiveType::Sphere, "BlinnPhong");
...
void LightingLayer::OnUpdate(float deltaTime)
{
...
void LightingLayer::OnEvent(Engine::Event& event)
{
	m_Camera.OnEvent(event);

	Engine::EventDispatcher dispatcher(event);

	dispatcher.Dispatch<Engine::KeyPressedEvent>(BIND_FN(LightingLayer::OnKeyPressed));
}

void LightingLayer::PerformCatwalkRoutine()
{
...
void LightingLayer::UploadLights(float x, float z)
{
	{
		for (uint32_t i = 0; i < m_SpotLightCount; i++)
		{
		...
		Engine::ShaderLibrary::Get("BlinnPhong")->Bind();
		Engine::ShaderLibrary::Get("BlinnPhong")->UploadUniformInt("u_UseDirectionalLight", m_UseDirectional ? 1 : 0);
		Engine::ShaderLibrary::Get("BlinnPhong")->UploadUniformInt("u_UsePointLights", m_UsePointLights ? 1 : 0);
		Engine::ShaderLibrary::Get("BlinnPhong")->UploadUniformInt("u_UseSpotLights", m_UseSpotLights ? 1 : 0);


		UploadDirectionalLightData(m_DirectionalLight, m_Camera, Engine::ShaderLibrary::Get("BlinnPhong"));
		...
		for (uint32_t i = 0; i < m_PointLightCount; i++)
		{
			...
			UploadPointLight(i, m_PointLights[i], lightViewSpacePosition, Engine::ShaderLibrary::Get("BlinnPhong"));
		}
		...
		for (uint32_t i = 0; i < m_SpotLightCount; i++)
		{
			...
			UploadSpotLightData(i, m_SpotLights[i], lightSpacePosition, lightViewSpaceDirection, Engine::ShaderLibrary::Get("BlinnPhong"));
		}
	}
}

void LightingLayer::DrawEntities()
{
	{
...
void LightingLayer::DrawSDFEntities()
{
...
void LightingLayer::DrawDebugLights()
{
	{
...
bool LightingLayer::OnKeyPressed(Engine::KeyPressedEvent& event)
{

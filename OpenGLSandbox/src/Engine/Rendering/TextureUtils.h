...
namespace Engine
{
	namespace ImageUtils
	{
		...
		{
			None = 0, FromImage,
			RGBA, RGB, RG, Red, DepthStencil, Depth,
			R8, R16, RG8, RG16, RGB4, RGB5, RGB8, RGB10, RGB12, RGBA2, RGBA4, RGBA8, RGBA12, RGBA16,
		...
		GLenum ConverDataLayoutMode(ImageDataLayout imageDataLayout);

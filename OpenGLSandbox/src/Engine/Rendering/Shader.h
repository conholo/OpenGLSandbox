...
namespace Engine
{
	...
	public:
		...
		ShaderUniform(const std::string& name, GLint location, ShaderAttributeType type, uint32_t size, uint32_t count, int32_t offset);
	...
	public:
		...
		void* GetUniformData(ShaderAttributeType type, GLint location);

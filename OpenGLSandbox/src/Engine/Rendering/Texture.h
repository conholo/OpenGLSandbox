...
namespace Engine
{
	...
	public:
		...
		static void Unbind();
		void BindToImageSlot(uint32_t unit, uint32_t level, ImageUtils::TextureAccessLevel access, ImageUtils::TextureShaderDataFormat shaderDataFormat) const;
	...
	public:
		...
		void BindToSamplerSlot(uint32_t slot = 0) const;
		static void Unbind();
		void BindToImageSlot(uint32_t Binding, uint32_t MipLevel, ImageUtils::TextureAccessLevel AccessLevel, ImageUtils::TextureShaderDataFormat ShaderDataFormat) const;

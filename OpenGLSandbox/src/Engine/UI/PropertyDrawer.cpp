#include "epch.h"
#include "Engine/UI/PropertyDrawer.h"
...
namespace Engine
{
	namespace UI
	{
		...
		UIPropertyType UIPropertyTypeFromShaderDataType(ShaderAttributeType ShaderDataType, bool isColor)
		{
			...
			{
			case ShaderAttributeType::Float:			return UIPropertyType::Float;
			case ShaderAttributeType::Float2:			return UIPropertyType::Vec2;
			case ShaderAttributeType::Float3:			return UIPropertyType::Vec3;
			case ShaderAttributeType::Float4:			return isColor ? UIPropertyType::Color : UIPropertyType::Vec4;
			case ShaderAttributeType::Int:				return UIPropertyType::Int;
			case ShaderAttributeType::Sampler2D:		return UIPropertyType::Texture;

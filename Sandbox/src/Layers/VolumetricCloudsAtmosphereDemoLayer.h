...
#include "Utility/Planet/Planet.h"
#include "Utility/Clouds/CloudDataStructures.h"

class VolumetricCloudsAtmosphereDemoLayer : public Engine::Layer
{
public:
	VolumetricCloudsAtmosphereDemoLayer();
	~VolumetricCloudsAtmosphereDemoLayer();

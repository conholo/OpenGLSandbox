#include "Layers/EnvironmentReflectionDemoLayer.h"
...
EnvironmentReflectionDemoLayer::EnvironmentReflectionDemoLayer()
...
void EnvironmentReflectionDemoLayer::OnAttach()
{
...
void EnvironmentReflectionDemoLayer::OnDetach()
{

}

void EnvironmentReflectionDemoLayer::OnUpdate(float deltaTime)
{
...
void EnvironmentReflectionDemoLayer::OnEvent(Engine::Event& event)
{
	Engine::EventDispatcher dispatcher(event);

	dispatcher.Dispatch<Engine::KeyPressedEvent>(BIND_FN(EnvironmentReflectionDemoLayer::OnKeyPressed));

	m_Camera.OnEvent(event);
}

bool EnvironmentReflectionDemoLayer::OnKeyPressed(Engine::KeyPressedEvent& event)
{
...
void EnvironmentReflectionDemoLayer::DrawReflectionScene()
{

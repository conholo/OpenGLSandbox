...
void main()
{
    ...
    {
        vec2 bloomTextureSize = vec2(textureSize(u_Texture, int(u_LOD + 1.0f)));
        float sampleScale = 1.0f;
        vec3 upsampledTexture = UpsampleTent9(u_Texture, u_LOD + 1.0f, texCoords, 1.0f / bloomTextureSize, sampleScale);
    ...
    {
        vec2 bloomTextureSize = vec2(textureSize(u_BloomTexture, int(u_LOD + 1.0f)));
        float sampleScale = 1.0f;
        vec3 upsampledTexture = UpsampleTent9(u_BloomTexture, u_LOD + 1.0f, texCoords, 1.0f / bloomTextureSize, sampleScale);

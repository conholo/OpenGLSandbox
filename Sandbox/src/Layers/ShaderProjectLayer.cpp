...
ShaderProjectLayer::ShaderProjectLayer()
...
void ShaderProjectLayer::OnAttach()
{
	...
	m_Entity = Engine::CreateRef<Engine::SimpleEntity>(tessellatedQuad, "Surfaces");
...
void ShaderProjectLayer::OnDetach()
{

}


void ShaderProjectLayer::OnUpdate(float deltaTime)
{
...
void ShaderProjectLayer::OnEvent(Engine::Event& event)
{
	m_Camera.OnEvent(event);
	Engine::EventDispatcher dispatcher(event);

	dispatcher.Dispatch<Engine::KeyPressedEvent>(BIND_FN(ShaderProjectLayer::OnKeyPressed));
}

void ShaderProjectLayer::OnImGuiRender()
{
	ImGui::Begin("Test");
...
bool ShaderProjectLayer::OnKeyPressed(Engine::KeyPressedEvent& keyPressedEvent)
{
